        ...
        <div className="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-gray-50 text-gray-800">
            <div className="fixed flex flex-col top-0 left-0 w-1/3 bg-white h-full border-r">
                <div className="flex items-center justify-center h-36 border-b">
                    <div className='block text-3xl'>Campus Connect</div>
                </div>
                ...
                <div className='flex items-center justify-center h-14 border-b'>
                    <a className={astyle} href='/'>Attendence</a></div>
                <div className='flex items-center justify-center h-14 border-b'>
                    <a className={astyle} href='/gatepasslog'>Gate Pass History</a></div>
                <div className='flex items-center justify-center h-14 border-b'>
                    <a className={astyle} href='/complaintlist'>Complaint History</a></div>
                <div className='flex items-center justify-center h-14 border-b'>
